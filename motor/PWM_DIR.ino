...
void loop() {
  ...
  // // MOTOR 3motor3.setSpeed(128);  // Run forward at 50% speed.
  // delay(1000);
  // Serial.print("Move forward 50%");
  // Serial.println();
  
  // motor3.setSpeed(255);  // Run forward at full speed.
  // delay(1000);
  // Serial.print("Move forward full speed");
  // Serial.println();
  ...
  // motor3.setSpeed(-128);  // Run backward at 50% speed.
  // delay(1000);
  // Serial.print("Move backwards 50%");
  // Serial.println();
  
  // motor3.setSpeed(-255);  // Run backward at full speed.
  // delay(1000);
  // Serial.print("Move backward full speed");
  // Serial.println();
  ...
  // MOTOR 4
  // motor4.setSpeed(128);  // Run forward at 50% speed.
  // delay(1000);
  // Serial.print("Move forward 50%");
  // Serial.println();
  
  // motor4.setSpeed(255);  // Run forward at full speed.
  // delay(1000);
  // Serial.print("Move forward full speed");
  // Serial.println();
  ...
  // motor4.setSpeed(-128);  // Run backward at 50% speed.
  // delay(1000);
  // Serial.print("Move backwards 50%");
  // Serial.println();
  
  // motor4.setSpeed(-255);  // Run backward at full speed.
  // delay(1000);
  // Serial.print("Move backward full speed");
  // Serial.println();
